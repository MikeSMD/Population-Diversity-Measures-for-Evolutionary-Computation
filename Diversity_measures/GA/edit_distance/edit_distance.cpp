...
template unsigned int edit_distance<std::vector<bool>>(const std::vector<bool>&, const std::vector<bool>&);

template unsigned int edit_distance<std::vector<int>>(const std::vector<int>&, const std::vector<int>&);
